...
namespace InsureCore.Mobile {
    ...
    public partial class InsureCoreMobileApplication : MobileApplication {
        ...
        private InsureCore.Module.Mobile.InsureCoreMobileModule module4;
        ...
        static InsureCoreMobileApplication() {
        ...
        #endregion
        public InsureCoreMobileApplication() {
        ...
        private void InsureCoreMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new InsureCore.Module.Mobile.InsureCoreMobileModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.InsureCoreMobileApplication_DatabaseVersionMismatch);
