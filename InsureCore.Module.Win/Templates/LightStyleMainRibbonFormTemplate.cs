...
namespace InsureCore.Module.Win.Templates
{
    public partial class LightStyleMainRibbonFormTemplate : RibbonForm, IActionControlsSite, IContextMenuHolder, IWindowTemplate, IDockManagerHolder, IBarManagerHolder, ISupportViewChanged, IXafDocumentsHostWindow, ISupportUpdate, IViewSiteTemplate, ISupportStoreSettings, IViewHolder, IPanelCaption
    {
        ...
        public LightStyleMainRibbonFormTemplate()
        {
            InitializeComponent();
            InitializeImages();
